 ...
 */
	...
	public E pop() {
		if(is_Empty)
			throw new MyEmptyStackExecption("Stack is empty");
		else {
		return null;
		}
	}
    ...
    /**
     * Returns the index of the first occurrence of the specified element on the stack.
     * You MUST specify your own Exception, if element not found!
     */
